(() => {
  ...
  function de(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (r.find(le(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          r.find(le(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function h() {
      ...
      0 !== s.length &&
        ...
        e.clickable &&
          s.on("click", le(e.bulletClass), function (e) {
            e.preventDefault();
    ...
    function f() {
      ...
      s.removeClass(e.hiddenClass),
        ...
        e.clickable && s.off("click", le(e.bulletClass));
    }
    i("init", () => {
    ...
    ce(),
      document.querySelector(".swiper") &&
        new oe(".swiper", {
          ...
          speed: 800,
          loop: !0,
          pagination: { el: ".testimonials__slider-pagging", clickable: !0 },
          breakpoints: {
  ...
  [...document.querySelectorAll(".item-basket-list")].forEach((e) => {
    e.querySelector(".item-basket-list__delete").addEventListener(
      "click",
      function (t) {
